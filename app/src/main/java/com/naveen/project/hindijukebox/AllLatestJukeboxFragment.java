...
import com.naveen.project.hindijukebox.adapters.JukeboxAdapter;
import com.naveen.project.hindijukebox.model.Movie;
 ...
 */
public class AllLatestJukeboxFragment extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<Movie>>{
    ...
    public AllLatestJukeboxFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_all_latest_jukebox, container, false);
        setHasOptionsMenu(true);
/*
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        searchView.setOnQueryTextListener(new MaterialSearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                recyclerView.setAdapter(new JukeboxAdapter(subMovieArrayList, getActivity(),"latest"));
                return false;
            }
        });
    ...
    public Loader<ArrayList<Movie>> onCreateLoader(int id, Bundle args) {
        ...
        String url="https://www.googleapis.com/youtube/v3/playlistItems?part=snippet%2CcontentDetails&maxResults=25&playlistId=PLUsLbqK_M40yR_0pgN50r0ZhP-adYrreq&key=AIzaSyAgOh3CKuy8d7ntlq7Ga-NrrRzNrKWWYvA";
        return new JukeboxLoader(getActivity(),Config.ALL_LATEST_JUKEBOX_URL);
    }
    ...
    public void onLoadFinished(Loader<ArrayList<Movie>> loader, ArrayList<Movie> data) {
        ...
        if (data.isEmpty()) {
            ...
            movieArrayList=data;
            jukeboxAdapter =new JukeboxAdapter(movieArrayList,getActivity(),"latest");
