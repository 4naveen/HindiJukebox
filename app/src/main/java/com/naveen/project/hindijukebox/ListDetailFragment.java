...
import com.naveen.project.hindijukebox.adapters.MovieReviewAdapter;
import com.naveen.project.hindijukebox.data.FavouriteContract;
import com.naveen.project.hindijukebox.model.Movie;
import com.naveen.project.hindijukebox.model.Review;
...
public class ListDetailFragment extends Fragment {
    ...
    String video_id,image_url,like,view_count,title,jukebox_type;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      //  ((AppCompatActivity) getActivity()).getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        jukebox_type=getArguments().getString("jukebox_type");
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (event.getAction() == KeyEvent.ACTION_DOWN) {
                    if (keyCode == KeyEvent.KEYCODE_BACK) {
                        ...
                        Fragment fragment;
                        if (jukebox_type.equalsIgnoreCase("latest")){
                            fragment = new AllLatestJukeboxFragment();
                        }
                        else {
                            fragment = new AllOldJukeboxFragment();
                        }
                        FragmentTransaction trans1 = getFragmentManager().beginTransaction();
                        trans1.replace(R.id.frame, fragment);
